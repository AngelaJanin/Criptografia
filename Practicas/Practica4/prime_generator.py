...
def miller_rabin(n):
    ...
    if esPar(n):
        ...
        s = 0
        r = n-1
        # Encontramos números que cumplan la igualdad
        while r % 2 == 0:
            r>>=1
            s+=1
        assert(2**s * r == n-1)
...
"""
Función auxiliar que determina si un número es par
:param n: el número a determinar si es par
:return: True si es par, sino regresa False
"""   
def esPar(n):
    return (n % 2) == 0
